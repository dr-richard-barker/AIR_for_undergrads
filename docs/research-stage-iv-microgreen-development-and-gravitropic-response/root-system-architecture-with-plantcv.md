...
description: >-
  ...
  and gravitropic angle — using the AIR Root Tool. A plain-language guide for the
  classroom.
---
...
You don't have to do these by hand. The **AIR Root Tool** does all four for you.

## Use the AIR Root Tool
