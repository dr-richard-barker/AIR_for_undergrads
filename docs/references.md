---
description: Key scientific literature behind the AIR program and the tools it uses.
---

# Literature & References

The papers below underpin the science, methods, and tools used across AIR. They range
from classroom-friendly overviews to advanced research — the Extension & Research stages
draw on the modelling and hydraulics references in particular.

!!! quote "Citing AIR"
    AIR itself is public domain (CC0). If you use it, a citation is appreciated — see
    [`CITATION.cff`](https://github.com/dr-richard-barker/AIRI/blob/main/CITATION.cff) in
    the repository.
...
- *The Virtual Root: Mathematical Modeling of Auxin Transport in the Arabidopsis Root Tip Using the Open-Source Software SimuPlant* (2021). *Methods in Molecular Biology*. [PubMed 34822153](https://pubmed.ncbi.nlm.nih.gov/34822153/) — the model behind our [Virtual Root simulator](https://dr-richard-barker.github.io/virtual-root/).
...
*Spotted a missing or incorrect reference? Use the edit pencil at the top of the page or
open an issue on [GitHub](https://github.com/dr-richard-barker/AIRI).*
